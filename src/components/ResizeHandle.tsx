...
export const ResizeHandle: React.FC<ResizeHandleProps> = ({ onResize, minMapHeight, maxMapHeight, currentMapHeight }) => {
  ...
  const handleMouseDown = useCallback((e: React.MouseEvent) => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const newMapHeight = Math.max(minMapHeight, Math.min(maxMapHeight, startMapHeight + deltaY));
